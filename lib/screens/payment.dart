...
class _PaymentState extends State<Payment> {
  String entity = '8acda4ca7be858f6017bfd9f88f643ed';
  ...
  void loadRequest() async {
    ...
    var request =
        http.Request('POST', Uri.parse('https://oppwa.com/v1/checkouts'));
    request.bodyFields = {
                          ...
                          child: WebView(
                            ...
                            onWebViewCreated: (webViewController) async {
                              ...
                              String kNavigationPage =
                                ...
                                <form action="https://sites.google.com/view/craftsapp/home" class="paymentWidgets" data-brands="VISA MASTER"></form>
                                </div>
                                </html>
                                ''';
