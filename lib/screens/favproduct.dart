...
class FavProduct extends StatefulWidget {
  FavProduct();
  @override
  _FavProduct createState() => _FavProduct();
}

class _FavProduct extends State<FavProduct> {
  String counter = '';
...
<soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
  <soap:Body>
    <FavProduct xmlns="http://Craft.WS/">
    ...
    http.Response response = await http
        .post('https://craftapp.net/services/CraftWebService.asmx',
            headers: {
              "SOAPAction": "http://Craft.WS/FavProduct",
    ...
    print(response.body);
    String json =
        parse(response.body).getElementsByTagName('FavProductResult')[0].text;
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                globals.loc == 'en' ? 'Favourites' : 'المفضلة',
                    ...
                    product.tag == ''
                        ...
                        : Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: product.fontcolor == '#000000'
                                  ? Border.all(
