...
class PaymentMada extends StatefulWidget {
  ...
  @override
  _PaymentMadaState createState() => _PaymentMadaState();
}

class _PaymentMadaState extends State<PaymentMada> {
  ...
  void loadRequest() async {
    ...
    request.bodyFields = {
      'entityId': '8acda4ca7be858f6017bfd9ff7f243f4',
              ...
              child: isLoading
                  ...
                  : Container(
                            ...
                            onWebViewCreated: (webViewController) async {
                              ...
                              String kNavigationPage =
                                  '''
                                      ...
                                      <form action="https://sites.google.com/view/craftsapp/home" class="paymentWidgets" data-brands="MADA"></form>
                                      </div>
                                      </html>
                                      ''';
                              final String contentBase64 = base64Encode(
                                  const Utf8Encoder().convert(kNavigationPage));
                              await _webViewController.loadUrl(Uri.encodeFull(
                            ...
                            navigationDelegate:
                              ...
                              if (request.url.startsWith(
                                ...
                                var request = http.Request(
                                    'GET',
                                    Uri.parse(
                                        'https://oppwa.com/v1/checkouts/$id/payment?entityId=8acda4ca7be858f6017bfd9ff7f243f4'));
                                ...
                                print(json);
                                final decoded = jsonDecode(json);
                                String bin = decoded['card']['bin'];
                                String lastdigit =
                                    decoded['card']['last4Digits'];
                                String holder = decoded['card']['holder'];
                                String expiry = decoded['card']['expiryMonth'] +
                                    '/' +
                                    decoded['card']['expiryYear'];

                                print(decoded['result']['code']);
                      ...
                      <PayLevel2 xmlns="http://Craft.WS/">
                        ...
                        <CreditNumber>$lastdigit</CreditNumber>
                        <ExpDate>$expiry</ExpDate>
                        <CreditHolder>$holder</CreditHolder>
