...
@objc class AppDelegate: FlutterAppDelegate,OPPCheckoutProviderDelegate,SFSafariViewControllerDelegate,PKPaymentAuthorizationViewControllerDelegate  {
  ...
  override func application(
    ...
    didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?
        ...
        GMSServices.provideAPIKey("AIzaSyDSBTT60PQy-4Sp33KAKbAI39I9i6Hidu4")
    if #available(iOS 10.0, *) {
     ...
     private func openCheckoutUI(checkoutId: String,result1: @escaping FlutterResult) {
        ...
        DispatchQueue.main.async{
            ...
            checkoutSettings.theme.navigationBarBackgroundColor = UIColor(red:0.91,green:0.73,blue:0.12,alpha:1.0)     
            ...
            if self.brand == "mada" {
                ...
                checkoutSettings.paymentBrands = ["VISA", "MASTER", "AMEX"]

            } else if self.brand == "APPLEPAY" {
                
                let paymentRequest = OPPPaymentProvider.paymentRequest(withMerchantIdentifier: "merchant.com.codino.crafts", countryCode: "SA")
                paymentRequest.paymentSummaryItems = [PKPaymentSummaryItem(label: "CRAFTAPP.", amount: NSDecimalNumber(value: self.amount))]
                if #available(iOS 12.1.1, *) {
                    paymentRequest.supportedNetworks = [ PKPaymentNetwork.mada,PKPaymentNetwork.amex,PKPaymentNetwork.visa,
                                                         PKPaymentNetwork.masterCard ]
                } else {
                    // Fallback on earlier versions
                    paymentRequest.supportedNetworks = [ PKPaymentNetwork.visa,PKPaymentNetwork.amex,
                                                               PKPaymentNetwork.masterCard ]
                }
            ...
            checkoutSettings.shopperResultURL = "com.codino.crafts://result"
    ...
    private func openCustomUI(checkoutId: String,result1: @escaping FlutterResult) {
        ...
        if self.STCPAY == "enabled" {
            ...
            do {
                ...
                params.shopperResultURL = "com.codino.crafts://result"
            ...
            if self.brand == "APPLEPAY" {
                ...
                let request = OPPPaymentProvider.paymentRequest(withMerchantIdentifier: "merchant.com.codino.crafts", countryCode: "SA")
        ...
        override func application(_ app: UIApplication, open url: URL, options: [UIApplication.OpenURLOptionsKey : Any] = [:]) -> Bool {
            ...
            if url.scheme?.caseInsensitiveCompare("com.codino.crafts") == .orderedSame && self.Presult != nil {
